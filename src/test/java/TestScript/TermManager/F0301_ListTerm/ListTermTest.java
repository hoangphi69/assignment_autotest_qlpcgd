package TestScript.TermManager.F0301_ListTerm;
...
public class ListTermTest extends ListTermPage{
  ...
  public void TC0203_NextPrevList() {
    ...
    Assert.assertTrue(driver.findElement(TermElement.NEXT_TERM).isDisplayed(), "TC02 FAILED: Không chuyển sang trang tiếp theo");
    ...
    Assert.assertTrue(driver.findElement(TermElement.PREV_TERM).isDisplayed(), "TC03 FAILED: Không quay lại trang trước");
